...
| `/tw_register` | Rolle `MEMBER_ROLE_ID` | `ally_code` | Verknüpft den eigenen Discord-Account mit einem (bereits bekannten) Ally-Code. Kein Signup-Zwang — Rosterdaten fließen auch ohne das, nur die Discord-Verknüpfung (für Pings) braucht diesen Schritt. |
